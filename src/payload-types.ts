...
export interface Config {
  ...
  jobs: {
    tasks: {
      'revalidate-every-morning': TaskRevalidateEveryMorning;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface Page {
  ...
  layout: (BannerBlock | CallToActionBlock | CodeBlock | ContentBlock | MediaBlock | FormBlock)[];
  meta?: {
    title?: string | null;
    /**
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'revalidate-every-morning';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'revalidate-every-morning') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskRevalidate-every-morning".
 */
export interface TaskRevalidateEveryMorning {
  input?: unknown;
  output?: unknown;
}
/**
